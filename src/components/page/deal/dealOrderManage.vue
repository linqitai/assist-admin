<template>
	<div class="table">
       ...
       <el-form ref="form" label-width="auto" :inline="false">
        ...
        <div>卖家买入次数:{{form.buyTimes}} 买入个数:{{form.buyAmount}} 卖出次数:{{form.sellTimes}} 卖出个数:{{form.sellAmount}} 身份证号:{{form.idCard}} 个人算力:{{form.myCalculationPower}} 团队算力:{{form.teamCalculationPower}} 实名人数:{{form.realnameNum}}</div>
