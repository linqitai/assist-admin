<template>
	<div class="table">
        ...
        <el-table-column prop="buyerNickName" label="买家昵称" min-width="120"></el-table-column>
				...
				<el-table-column prop="letSureTime" label="确认截止时间" min-width="180" fixed="right"></el-table-column>
				<el-table-column prop="coinReleaseTime" label="放币时间" min-width="180" fixed="right"></el-table-column>
