  ...
  <div class="table">
    ...
    <div class="container">
      ...
      <el-table :data="tableData" border stripe class="table" ref="multipleTable" style="width: 100%">
        ...
        <el-table-column prop="deadTime" label="截止时间" min-width="170"></el-table-column>
    ...
    <el-dialog :title="visibleType=='add'?'新建':'编辑'" :visible.sync="addOrEditVisible" width="400px">
      <el-form ref="form" :model="form" label-width="auto">
        ...
        <el-form-item label="是否发布" prop="isPublish">
          <el-switch @change="isPublishChange" v-model="form.isPublish" active-text="是" inactive-text="否">
          </el-switch>
        </el-form-item>
      </el-form>
